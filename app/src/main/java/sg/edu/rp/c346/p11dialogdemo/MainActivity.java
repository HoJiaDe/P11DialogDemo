package sg.edu.rp.c346.p11dialogdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnDemo1, btnDemo2, btnDemo3, btnDemo4, btnDemo5, btnEx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEx = findViewById(R.id.buttonEx3);
        tvDemo2 = findViewById(R.id.textViewDemo2);
        tvDemo3 = findViewById(R.id.textViewDemo3);
        tvDemo4 = findViewById(R.id.textViewDemo4);
        tvDemo5 = findViewById(R.id.textViewDemo5);
        tvEx = findViewById(R.id.textViewEx3);
        ...
        btnEx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText etN1 = viewDialog.findViewById(R.id.editText1);
                final EditText etN2 = viewDialog.findViewById(R.id.editText2);
